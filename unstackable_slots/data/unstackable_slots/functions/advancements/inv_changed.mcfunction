...
execute store result score shinv_compatibility USS.vars if data storage minecraft:juloos.datapacks shared_inventory if score enabled shinv.vars matches 1
